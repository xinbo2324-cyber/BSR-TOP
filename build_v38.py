...
SOURCE_HTML = ROOT / "index_v37.html"
OUTPUT_HTML = ROOT / "index_v38.html"
...
def main():
    ...
    html = html.replace(
        '<tr><td><strong>v37</strong></td>',
        f'<tr><td><strong>v38</strong></td><td>2026-09-15</td><td>更新《月度品牌调研_汇总_归类版》的 BSR榜单汇总子表数据。</td><td>仅内置该子表的 {len(payload_data["data"])} 条有效记录，空白说明行不导入；保留现有功能与筛选规则。</td><td><span class="tag tag-green">正式发布</span></td></tr>\n      <tr><td><strong>v37</strong></td>',
        1,
    )
